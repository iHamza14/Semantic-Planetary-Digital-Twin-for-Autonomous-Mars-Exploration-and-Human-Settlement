...
def evaluate_on_test_set(
    ...
    data_dir: str = "/run/media/wolverine/Windows/ML dataset/Offroad_Segmentation_testImages",
    batch_size: int = 4,
    num_workers: int = 0,
...
def main():
    ...
    parser.add_argument("--data-dir", default="/run/media/wolverine/Windows/ML dataset/Offroad_Segmentation_testImages", help="Dataset root directory")
